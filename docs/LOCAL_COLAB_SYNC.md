...
Colab은 학습과 export만 수행한다. GitHub와 Hugging Face 인증, 코드 push, 모델
...
candidate를 그대로 공개하지 않는다. CTIBench 고정 평가, 오염 검사, artifact integrity,
provenance, license, privacy, safety 승인과 measured gate report를 먼저 생성한다.
